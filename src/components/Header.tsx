...
const blog = [
    {
        name: "Buat Blog",
        description: "Yuk buat postingan blog terbaru",
        href: "/blog/create",
        icon: SquaresPlusIcon,
    },
    {
        name: "Kelola Blog",
        description: "Lihat seluruh aktivitas melalui blog kami",
        href: "/blog/kelola",
        icon: SquaresPlusIcon,
    },
    {
    ...
    {
        name: "Blog Resmi KKN Undiksha",
        description: "Laman blog resmi KKN Undiksha",
        href: "https://kkn.undiksha.ac.id/blog",
        icon: SquaresPlusIcon,
    },
];
